package de.lars.drugs.handler.languagehandler.infohandler;
...
public class InfoHandler {
    ...
    public InfoHandler(final Drugs plugin) {
        this.plugin = plugin;
        this.messages = new HashMap<>();
        this.messageConfig = new Configuration(new File(plugin.getDataFolder(), "/languages/info/Info.yml"));
        this.messageConfig.setTemplateName("/languages/info/Info.yml");
        reloadMessages();
    }
