...
public class ENHandler {
    ...
    public ENHandler(final Drugs plugin) {
        this.plugin = plugin;
        this.messages = new HashMap<>();
        this.messageConfig = new Configuration(new File(plugin.getDataFolder(), "/languages/en.yml"));
        this.messageConfig.setTemplateName("/languages/en.yml");
        reloadMessages();
    }
