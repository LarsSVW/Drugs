...
public class DEHandler {
    ...
    public DEHandler(final Drugs plugin) {
        this.plugin = plugin;
        this.messages = new HashMap<>();
        this.messageConfig = new Configuration(new File(plugin.getDataFolder(), "/languages/de.yml"));
        this.messageConfig.setTemplateName("/languages/de.yml");
        reloadMessages();
    }
