...
public class FRHandler {
    ...
    public FRHandler(final Drugs plugin) {
        this.plugin = plugin;
        this.messages = new HashMap<>();
        this.messageConfig = new Configuration(new File(plugin.getDataFolder(), "/languages/fr.yml"));
        this.messageConfig.setTemplateName("/languages/fr.yml");
        reloadMessages();
    }
