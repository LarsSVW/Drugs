...
public class RUHandler {
    private final Drugs plugin;
    private final Map<String, String> messages;

    private final Configuration messageConfig;

    public RUHandler(final Drugs plugin) {
        this.plugin = plugin;
        this.messages = new HashMap<>();
        this.messageConfig = new Configuration(new File(plugin.getDataFolder(), "/languages/ru.yml"));
        this.messageConfig.setTemplateName("/languages/ru.yml");
        reloadMessages();
    }
