...
import static de.lars.drugs.handler.CreatedItems.createLysergicAcid;
...
public class LysergicAcidGUI {
    ...
    public LysergicAcidGUI(Drugs plugin, Configuration config) {
        this.config = config;
        this.plugin = plugin;
    }

    public void open(Player player) {
        ChestGui gui = new ChestGui(5, "Lysergic Acid Crafting Recipe");
        ...
        ItemStack resultitem = createLysergicAcid(plugin, config);
        ...
        pane.addItem(natriumGuiItem, 1, 1);
        pane.addItem(hydrogenGuiItem, 2, 1);
        pane.addItem(natriumGuiItem, 3, 1);
        pane.addItem(hydrogenGuiItem, 1, 2);
        pane.addItem(natriumGuiItem, 2, 2);
        pane.addItem(hydrogenGuiItem, 3, 2);
        pane.addItem(natriumGuiItem, 1,3);
        pane.addItem(hydrogenGuiItem, 2,3);
        pane.addItem(natriumGuiItem,3,3);
